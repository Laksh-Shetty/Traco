...
const cards = [
  {
    title: "Budgeting",
    description:
      "Create and manage budgets to keep your spending on track every month.",
    video: "money-bag.mp4",
    accent: "#2271f0",
  },
  {
    ...
    description:
      "Monitor expenses in real-time with automatic detailed categorization.",
  ...
  },
  {
    ...
    description:
      "Receive timely alerts for budget limits, due dates, and account activity.",
    video: "message.mp4",
    accent: "#2271f0",
  },
  {
    ...
    description:
      "Your financial data available anytime, on any device, instantly.",
    video: "click.mp4",
    accent: "#d006d4",
  },
  {
    ...
    description:
      "Leverage AI to surface personalized financial insights and recommendations.",
  ...
  },
  {
    title: "Save More",
    description:
      "Identify saving opportunities automatically and reach your goals faster.",
    video: "save-money.mp4",
    accent: "#d006d4",
  },
];

function Card({ card, index, dark, tk }) {
